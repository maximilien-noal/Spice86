...
public class Timer : DefaultIOPortHandler, ITimeMultiplier {
    ...
    private readonly PitPicEventQueue? _pitPicEventQueue;
    ...
    public void SetTimeMultiplier(double multiplier) {
        ...
        _pitPicEventQueue?.SetTimeMultiplier(multiplier);
    }
