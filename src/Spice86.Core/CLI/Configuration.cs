...
public sealed class Configuration {
    ...
    /// </summary>
    [Option(nameof(McpServer), Default = true, Required = false, HelpText = "Enable MCP (Model Context Protocol) server with stdio transport for programmatic emulator state inspection")]
